...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="continentes.php?action=create" class="btn btn-primary">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $row['id_continente']; ?></td>
                        <td><?php echo $row['nombre_continente']; ?></td>
                        <td><?php echo $row['codigo_continente']; ?></td>
                        <td><?php echo number_format($row['poblacion_aproximada']); ?></td>
                        <td><?php echo number_format($row['area_km2'], 2); ?></td>
                        <td>
                            <a href="continentes.php?action=edit&id=<?php echo $row['id_continente']; ?>" 
                               class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="continentes.php?action=delete&id=<?php echo $row['id_continente']; ?>" 
